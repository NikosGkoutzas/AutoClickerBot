...
class Action(ActionInterface):
    ...
    def update_machine_procedure(self) -> None:
        ...
        if (updated == 1):
            ...
            print(
                f'{self.read_files.read_total_updates()}/{os.getenv('total_required_updates')} machines updated.')
    ...
    def open_teamviewer(self) -> None:
        ...
        try:
            ...
            print(
                f'An error occured while trying to open teamviewer: {str(e)}')
    ...
    def close_teamviewer(self) -> None:
        ...
        try:
            ...
            subprocess.run(['pkill', 'teamviewer'],
                           check=False,
                           stdout=subprocess.DEVNULL,
                           stderr=subprocess.DEVNULL)
            ...
            print(
                f'An error occured while trying to close teamviewer: {str(e)}')
            self.write_files.write_total_errors()
    ...
    def _is_teamviewer_gui_enable(self) -> bool:
        ...
        '''
        result = subprocess.run(['pgrep', '-af', 'teamviewer'],
