...
class ReadFiles(ReadFilesInterface):
    ...
    def read_number_of_urls(self) -> int:
        ...
        try:
            ...
            raise ValueError(
                f'File {urls_filename} does not contain a valid integer.')
    ...
    def read_app_version(self) -> str:
        ...
        try:
            ...
            raise ValueError(
                f'File {urls_filename} does not contain a valid string.')
        ...
        try:
            ...
            with open(urls_filename, 'r') as f:
                ...
                if (current_pos > len(lines) or current_pos < 1):
                    raise ValueError(
                        'An error occured in function \'read_url_from_current_pos\'. Current position of element and number of url links does not match.')
    ...
    def read_update_number_of_machine(self) -> list[int]:
        ...
        try:
            ...
            raise ValueError(
                f'File {updates_per_machine_filename} does not contain valid values.')
    ...
    def read_email_uids(self) -> list[bytes]:
        ...
        try:
            ...
            raise ValueError(
                f'File {url_current_pos_filename} does not contain a valid byte.')
