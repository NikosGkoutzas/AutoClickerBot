...
class SendEmail(SendEmailInterface):
    #@inject.autoparams()
    def __init__(self , read_files_interface: ReadFilesInterface , email_message_interface: EmailMessagesInterface , calculations_interface: CalculationInterface):
    ...
    '''def send_email_10_errors_occured(self) -> None:
        self.send_email_to_all_receivers(TEN_ERRORS_DETECTED_TITLE_MESSAGE , TEN_ERRORS_DETECTED_BODY_MESSAGE)'''
    ...
    def send_email_new_version_updated(self , new_version: str , new_time: datetime.time) -> None:
        self.send_email_to_all_receivers(self.email_message.new_version_started_title_message() , self.email_message.new_version_started_body_message(new_version , new_time))
    ...
    def send_email_captcha_problem(self) -> None:
        self.send_email_to_all_receivers(self.email_message.captcha_problem_title_message() , self.email_message.captcha_problem_body_message())